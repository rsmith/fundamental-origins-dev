(function() {
  var Promise, _gulp, _task, _tasks, executeTask, foreach, gulp, humanizeTime, isPromise, isStream, streamToPromise, tag;
  ...
  _task.run = function(name) {
    var end, ref, startTime, task;
    if (typeof name === "string") {
      task = (ref = _tasks[name]) != null ? ref.callback : void 0;
      if (task == null) {
